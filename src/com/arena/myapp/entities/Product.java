...
public class Product {
    ...
    public Product(String name, int price, int qty, String desc) {
        this.name = name;
        this.qty = qty;
        this.desc = desc;
        this.price = price;
    ...
    public Product(int id, String name, int price, int qty, String desc, String image, Category cat) {
        this.id = id;
        this.name = name;
        this.qty = qty;
        this.desc = desc;
    ...
    public Product(String name, int price, int qty, String desc, String image, Category cat) {
        this.name = name;
        this.qty = qty;
        this.desc = desc;
        this.image = image;
