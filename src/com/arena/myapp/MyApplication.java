...
import com.arena.myapp.gui.Stat;
import com.arena.myapp.gui.Stat;
...
public class MyApplication {
    ...
    User u = new User ( "nourbouj" , "nourbouj", "nour.jpg", "nour.bouj@gmail.com", "12345678", "21548787", 5 ,"joueur", "non", "joueur", "nourtry") ;
    public void start() {
        if(current != null){
            current.show();
            return;
