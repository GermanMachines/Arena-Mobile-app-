...
public class UpdateCategoryForm extends BaseForm {
    Form current;
    public UpdateCategoryForm(Resources res,Category a){
       
        super(BoxLayout.y());
         System.out.println(a.getId());
        getContentPane().setScrollVisible(true);
        super.addSideMenu(res);
           TextField tfNomCategorie= new TextField(a.getName(),"Titre",20,TextField.ANY);
            tfNomCategorie.setUIID("TextFieldBlack"); 
            
            TextField tfDescCategorie= new TextField(a.getDesc(),"Titre",20,TextField.ANY);
            tfDescCategorie.setUIID("TextFieldBlack"); 
        ...
        btnValider.setUIID("Button");
            ...
            a.setName(tfNomCategorie.getText());
              a.setDesc(tfDescCategorie.getText());

             if( ServiceCategory.getInstance().updateCategory(a)){
   ...
   //status.setIcon(res.getImage("done.png").scaledSmallerRatio(Display.getInstance().getDisplayWidth()/10, Display.getInstance().getDisplayWidth()/15));
                      ...
                      status.show();
               new ListCategoryForm(res,a).show();
        });
         addAll(tfNomCategorie,tfDescCategorie, btnValider);
       show();
    }
}
